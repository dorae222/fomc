...
start_et = tz_ny.localize(datetime(2025, 6, 18, 9, 25))   # 장시작 직전부터
end_et   = tz_ny.localize(datetime(2025, 6, 18, 16, 5))   # 장마감 직후까지
...
# 결과 확인 & 저장
print(df.head())
df.to_csv("QQQ_5m_2025-06-18_ET.csv")
print("saved -> QQQ_5m_2025-06-18_ET.csv")
...
# FOMC 타임스탬프 (ET)
stmt_time = tz_ny.localize(datetime(2025, 6, 18, 14, 0))   # 성명문
pc_time   = tz_ny.localize(datetime(2025, 6, 18, 14, 30))  # 기자회견 시작
...
# 포맷팅
ax.set_title("QQQ 5-minute bars on 2025-06-18 (ET)")
...
df_pres = pd.read_csv("/home/cora3/workSpace/fomc_py/fomc/results/pred_20250618pres.csv")
df_mone = pd.read_csv("/home/cora3/workSpace/fomc_py/fomc/results/pred_20250618mone.csv")
...
plt.tight_layout()
plt.savefig("QQQ_5m_2025-06-18_with_sentiment.png")
print("saved -> QQQ_5m_2025-06-18_with_sentiment.png")
